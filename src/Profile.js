...
class ViewProfile extends React.Component {
    ...
    componentDidMount() {
        ...
        fetch(`${baseUrl}/get-profile/${userId}`)
            .then(response => {
            ...
            .then(response => {
                ...
                this.setState({
                    ...
                    preferenceMorning: response[1][0].preferenceMorning,
                    preferenceEvening: response[1][0].preferenceEvening,
                    preferenceNoon: response[1][0].preferenceNoon
                });
                cookies.set('date_created', response[1][0].data_inregistrare);
                //il punem in state
                fetch(`${baseUrl}/get-profile/${userId}`)
                    .then(responsee => {
                            ...
                            <Grid.Column>
                                ...
                                <Segment color="green" secondary attached>
                                    <List horizontal divided relaxed>
                                        <List.Item>
                                            <List.Content>
                                                Morning: {this.state.preferenceMorning}
                                            </List.Content>
                                        </List.Item>
                                        <List.Item>
                                            <List.Content>
                                                Evening: {this.state.preferenceEvening}
                                            </List.Content>
                                        </List.Item>
                                        <List.Item>
                                            <List.Content>
                                                Noon: {this.state.preferenceNoon}
                                            </List.Content>
                                        </List.Item>
                                    </List>
                                </Segment>
...
class EditProfile extends React.Component {
    constructor(props) {
        ...
        axios.get(`${baseUrl}/get-profile/${userId}`)
            .then(response => {
                this.setState({
                    prenume: response.data[1][0].prenume,
                    nume: response.data[1][0].nume,
                    email: response.data[1][0].email,
                    preferenceMorning: response.data[1][0].preferenceMorning,
                    preferenceEvening: response.data[1][0].preferenceEvening,
                    preferenceNoon: response.data[1][0].preferenceNoon
                });
            });
    }
    changeHandler = e => {
    ...
    componentDidUpdate() {
        for (let property in this.state) {
            if (this.state[property]) {
                axios.get(`${baseUrl}/edit-profile/${userId}/${property}/${this.state[property]}`).
                    then(response => {
                                        ...
                                        <List divided relaxed>
                                            <List.Item>
                                                <List.Content>
                                                    ...
                                                    <input
                                                        name="preferenceMorning"
                                                        type="text"
                                                        value={preferenceMorning}
                                                        placeholder="Change Morning Difficulty..."
                                                        onChange={this.changeHandler}
                                                    />
                                                </List.Content>
                                            </List.Item>
                                            <List.Item>
                                                <List.Content>
                                                    ...
                                                    <input
                                                        name="preferenceNoon"
                                                        type="text"
                                                        value={preferenceNoon}
                                                        placeholder="Change Afternoon Difficulty..."
                                                        onChange={this.changeHandler}
                                                    />
                                                </List.Content>
                                            </List.Item>
                                            <List.Item>
                                                <List.Content>
                                                    ...
                                                    <input
                                                        name="preferenceEvening"
                                                        type="text"
                                                        value={preferenceEvening}
                                                        placeholder="Change Evening Difficulty..."
                                                        onChange={this.changeHandler}
                                                    />
                                                </List.Content>
                                            </List.Item>
